...
### 01️⃣ Customer Experience & Loyalty Dashboard (Restaurant Case Study)
**Focus:** Customer satisfaction, loyalty, and vulnerability analysis  
**Highlights:**
- CSAT, NPS, Permanence Index, and vulnerability metrics
- Identification of churn risk driven by shared consumption
- Executive storytelling for service improvement decisions  

📂 Folder: `01_customer_experience_dashboard`

---

### 02️⃣ Commercial Analytics & Churn Prediction (Retail Case Study)
**Focus:** Sales analytics, ABC segmentation, and churn prediction  
**Highlights:**
- End-to-end analytics pipeline in Python
- EDA, Pareto (80/20) segmentation, and ML-based churn scoring
- Integration of technical analysis with executive dashboards  

📂 Folder: `02_commercial_analytics_churn`

---

### 03️⃣ Financial Education Analytics – Program Monitoring
**Focus:** Academic performance and engagement monitoring  
**Highlights:**
- Enrollment vs completion analysis
- Learning outcomes by campus, cycle, and modality
- Power BI Service dashboard for program tracking  

🔗 Live Dashboard (Power BI Service)  
📂 Folder: `03_financial_education_analytics`

---

### 04️⃣ Financial Education & CX Analytics – Results & Experience
**Focus:** Learning impact and customer experience evaluation  
**Highlights:**
- Entry vs exit learning assessment
- CES, CSAT, and NPS analysis
- Certification rates and engagement gaps
- Large-scale analysis (600+ participants)  

🔗 Live Dashboard (Power BI Service)  
📂 Folder: `04_financial_education_cx_analytics`
